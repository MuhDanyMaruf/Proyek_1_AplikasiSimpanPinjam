...
function getjumangsur() {
  ...
  xmlhttp3.open(
    "get",
    "getdata.php?no=" + kode + "&ktp=" + ktp + "&ambil=jumlah_angsur",
    true
  );
  xmlhttp3.onreadystatechange = function () {
    if (xmlhttp3.readyState == 4 && xmlhttp3.status == 200) {
      document.getElementById("jumlah_angsur").innerHTML =
...
function getsisaangsur() {
  ...
  xmlhttp4.open(
    "get",
    "getdata.php?no=" + kode + "&ambil=angsur_ke&ktp=" + ktp,
    true
  );
...
function getBesarSaldo() {
  ...
  xmlhttp6.open(
    "get",
    "getdata.php?no=" + kode + "&jns=" + jns + "&ambil=besar_saldo",
    true
  );
...
function getBesarSaldo2() {
  ...
  xmlhttp8.open(
    "get",
    "getdata.php?no=" + kodes + "&jns=" + jnss + "&ambil=besar_saldo",
    true
  );
...
function getBesarSimpanWajib() {
  ...
  xmlhttp7.open(
    "get",
    "getdata.php?no=" + kode + "&ambil=besarSimpanWajib",
    true
  );
...
function validPinjam() {
  ...
  if (jns == 2) {
    if (saldo - pinjam < 0) {
      if (
        confirm(
          "Maaf! saldo tidak mencukupi! Apakah anda ingin meminjam pada koperasi?"
        ) == false
      ) {
...
function textOtomatis(f, tinggiMaksimal) {
  ...
  var tinggiMaksimal =
    typeof tinggiMaksimal == "undefined" ? 1000 : tinggiMaksimal;
