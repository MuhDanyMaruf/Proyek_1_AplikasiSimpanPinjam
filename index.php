...
?>
    ...
    <body>
      ...
      *********************************************************************************************************************************************************** -->
                ...
                <ul style="float:right; margin-top:12px;">
                    <li>
                        ...
                        <a class="logout" href="login/proses_logout.php">
                            <?php
                            if ($_SESSION['level'] == 'admin') {
                                echo '<button class="btn btn-info" style="border:3px solid #fff;">
                                <span class="glyphicon glyphicon-off"></span> Logout</button>';
                            } else if ($_SESSION['level'] == 'operator') {
                                echo '<button class="btn btn-success" style="border:3px solid #fff;">
                                <span class="glyphicon glyphicon-off"></span> Logout</button>';
                            }
                            ?>
                        </a>
                ...
                <div id="sidebar" class="nav-collapse">
                    ...
                    ?>
                        <ul class="sidebar-menu" id="nav-accordion">
                            <p class="centered"><a href="#"><img src="logo1.jpg" class="img-circle" width="60"></a></p>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <!-- <li><a href="index.php?pilih=4.7"><i class="glyphicon glyphicon-tint"></i>Master Petugas</a></li>v  -->
                    ...
                    ?>
                    <hr>
                    <!-- <center>Distributed by <a href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a> -->
                    </center>
                    <!-- sidebar menu end-->
                </div>
            </aside>
        ...
        <!-- js ditempatkan di akhir dokumen sehingga halaman memuat lebih cepat -->
