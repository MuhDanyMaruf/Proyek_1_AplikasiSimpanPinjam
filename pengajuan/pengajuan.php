...
?>
  <div class="row mt">
    <div class="col-lg-12">
      <div class="form-panel">
        <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Data Pengajuan
          <?php $dfl = mysql_fetch_array(mysql_query("SELECT *from t_anggota where kode_anggota='$kodeaa'"));
          echo $dfl['nama_anggota']; ?><span style="float:right;">
            <input type="text" id="cari" style="width:230px;height:30px;font-size:15px;" placeholder=" cari disini...">

            <?php $verida = mysql_fetch_array(mysql_query("SELECT * FROM t_pengajuan where kode_anggota='$kodeaa' order by kode_pengajuan desc"));
