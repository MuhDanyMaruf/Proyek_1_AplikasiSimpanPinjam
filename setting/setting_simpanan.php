        ...
        <div class="form-panel">
          <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Setting Data Simpanan
            ...
            echo '<kbd style="background-color:#d9534f;">' . $jum . '</kbd>'; ?><span style="float:right;">
              <?php if ($jum <= 2) {
                echo '<a class="btn btn-primary" href="?pilih=4.1&aksi=tambah"><i class="glyphicon glyphicon-plus"></i> Tambah</a>';
              } else {
                echo '<a class="btn btn-primary" href="?pilih=4.1&aksi=tambah" disabled="disabled"><i class="glyphicon glyphicon-plus"></i> Tambah</a>';
              } ?>
            </span></h4>
