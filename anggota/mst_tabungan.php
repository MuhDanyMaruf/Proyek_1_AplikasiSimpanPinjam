...
if (empty($aksi)) {
  ...
  while ($dataku = mysql_fetch_array($ghu)) {
    $fgh = $dataku['tgl_mulai'];
    $tang = date("Y-m-d");
    $kode_tab = $dataku['kode_tabungan'];
            ...
            <table class="table table-bordered table-striped table-condensed">
              ...
              <tbody id="fbody">
                ...
                ?>
                  ...
                  <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $data['kode_tabungan'];
                        echo '</td>
            <td>';
                        echo $d = $data['kode_anggota'];
                        echo '</td>';
                        $d = $data['kode_anggota'];
                ...
                <tr class="info">
                  ...
                  <td colspan="2">Rp. <?php $bu = mysql_fetch_array(mysql_query("SELECT sum(besar_tabungan) as besar_tab from t_tabungan"));
                                      echo number_format($bu['besar_tab']);
                                      echo '</td>'; ?>
                </tr>
              </tbody>
            </table>
          ...
          <form class="form-inline" role="form">
            ...
            <td>';
                ...
                <tr class="info">
                  ...
                  <td colspan="2">Rp. <?php $bu = mysql_fetch_array(mysql_query("SELECT sum(besar_ambil) as besar_ambil from t_pengambilan where kode_anggota='$luy'"));
                                      echo number_format($bu['besar_ambil']);
                                      echo '</td>'; ?>
                </tr>
              </tbody>
            </table>
