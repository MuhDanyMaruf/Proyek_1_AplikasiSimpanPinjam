...
(function () {
      ...
      for (
        ...
        e.push(d),
          j === E[va]
            ...
            ? (d = Za(h, m + b * k))
            : !g && (j === E[oa] || j === E[Wa])
            ? (d = Za(h, m, l + b * k * (j === E[oa] ? 1 : 7)))
            : (j <= E[Oa] && d % E[oa] === i && (f[d] = oa), (d += j * k)),
          b++;
      e.push(d);
    }
  ...
  var x,
    ...
    Sa,
    fb = z.documentElement.ontouchstart !== x,
    Lb = {},
    tb = 0,
    $a,
    N,
  ...
  N = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/3.0.1/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/3.0.1/gfx/vml-radial-gradient.png",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 5,
          ...
          if (
            ...
            if (c === "d")
              ...
              (e = g.getElementsByTagName("title")[0]),
                e || ((e = z.createElementNS(sa, "title")), g.appendChild(e)),
                (e.textContent = d);
            c === "strokeWidth" && (c = "stroke-width");
        ...
        if (b.tagName === "SPAN") {
          ...
          if (G !== this.cTT) {
            ...
            if (k > l && /[ \-]/.test(b.textContent || b.innerText))
              L(b, { width: l + "px", display: "block", whiteSpace: "normal" }),
                (k = l);
  ...
  Aa.prototype = {
    ...
    init: function (a, b, c, d) {
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(z.createTextNode("Created with Highcharts 3.0.1"));
        ...
        n(l, function (e) {
          if (e !== "" || l.length === 1) {
            var p = {},
              ...
              q;
            g.test(e) &&
              ((q = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2")),
              A(n, "style", q));
            h.test(e) &&
              !d &&
              (A(n, "onclick", 'location.href="' + e.match(h)[1] + '"'),
              L(n, { cursor: "pointer" }));
            e = (e.replace(/<(.|\n)*?>/g, "") || " ")
              .replace(/&lt;/g, "<")
              .replace(/&gt;/g, ">");
            ...
            !o &&
              ...
              A(
                ...
                m ||
                  c.fontMetrics(
                    /px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize
                  ).h,
                db && n.offsetHeight
              ));
            b.appendChild(n);
                  ...
                  !p || e.length === 1
                    ? ((e = t),
                      ...
                      e.length &&
                        ...
                        b.appendChild(n),
                        r > k && (k = r)))
                    : (n.removeChild(n.firstChild), t.unshift(e.pop())),
                  e.length &&
                    n.appendChild(
    ...
    color: function (a, b, c) {
      ...
      if (g) {
        ...
        h[p]
          ...
          : ((c.id = a = "highcharts-" + tb++),
            ...
            n(j, function (a) {
              ...
              a = d
                .createElement("stop")
                .attr({ offset: a[0], "stop-color": k, "stop-opacity": m })
                .add(i);
              i.stops.push(a);
            }));
        return "url(" + d.url + "#" + a + ")";
        ...
        return f.test(a)
          ? ((e = ma(a)), A(b, c + "-opacity", e.get("a")), e.get("rgb"))
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        a = o.element.style;
        w =
          (La === void 0 || xb === void 0 || s.styles.textAlign) && o.getBBox();
            ...
            (a = t(-G * q)),
              ...
              (s.box = B =
                d
                  ...
                  : p.rect(a, b, s.width, s.height, 0, u[Nb])),
              B.add(s);
          ...
          for (c in a)
            if (
              ...
              if (
                ...
                l = [];
                for (var o; e--; )
                  if (Ca(d[e])) l[e] = t(d[e] * 10) - 5;
                  else if (d[e] === "Z") l[e] = "x";
                  else if (
                    ((l[e] = d[e]), d.isArc && (d[e] === "wa" || d[e] === "at"))
                  )
                    (o = d[e] === "wa" ? 1 : -1),
                      l[e + 5] === l[e + 7] && (l[e + 7] -= o),
                      l[e + 6] === l[e + 8] && (l[e + 8] -= o);
    ...
    var na = {
      ...
      color: function (a, b, c, d) {
        ...
        if (i) {
          ...
          n(a, function (a, b) {
            g.test(a[1])
              ? ((f = ma(a[1])), (k = f.get("rgb")), (m = f.get("a")))
              : ((k = a[1]), (m = 1));
            t.push(a[0] * 100 + "% " + k);
            b ? ((o = m), (B = k)) : ((s = m), (w = k));
          });
            ...
            if (i === "gradient")
              ...
              var j = l.r,
                ...
                j = function () {
                  y &&
                    ((u = d.getBBox()),
                    (H += (y[0] - u.x) / u.width - 0.5),
                    (C += (y[1] - u.y) / u.height - 0.5),
                    (v *= y[2] / u.width),
                    (P *= y[2] / u.height));
                  q =
                    'src="' +
      ...
      symbols: {
        ...
        rect: function (a, b, c, d, e) {
          var f = a + c,
            ...
            h;
          !r(e) || !e.r
            ? (f = Aa.prototype.symbols.square.apply(0, arguments))
            : ((h = K(e.r, c, d)),
              (f = [
                "M",
                a + h,
      ...
      if (l && w)
        r === "inside" && (w = -w),
          ...
          p
            ...
            : (this.mark = f
                .path(b)
                .attr({ stroke: q, "stroke-width": l, opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(H))
  ...
  ab.prototype = {
    ...
    setOptions: function (a) {
      this.options = y(
        ...
        y(N[this.isXAxis ? "xAxis" : "yAxis"], a)
      );
    },
    update: function (a, b) {
      var c = this.chart,
        a = (c.options[this.xOrY + "Axis"][this.options.index] = y(
          this.userOptions,
          a
        ));
      this.destroy();
        ...
        if (g.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((j = g.xData), j.length))
              (a.dataMin = K(o(a.dataMin, j[0]), Fa(j))),
            ...
            for (h = 0; h < v; h++) {
              ...
              if (k)
                (H = (P = G < t) ? l : m),
                  (C = P ? n : p),
                  r(H[w])
                    ? ((H[w] = ia(H[w] + G)), (G = [G, H[w]]))
                    : (H[w] = G),
                  c[C] || (c[C] = {}),
                  c[C][w] ||
                    (c[C][w] = new Ib(a, a.options.stackLabels, P, w, s, k)),
                  c[C][w].setTotal(H[w]),
                  (c[C][w].touched = f);
    ...
    translate: function (a, b, c, d, e, f) {
      ...
      b
        ...
        : (e && (a = this.val2lin(a)),
          (a =
            h * (a - d) * j + i + h * k + (f ? (j * this.pointRange) / 2 : 0)));
      return a;
    },
    ...
    getLogTickPositions: function (a, b, c, d) {
      ...
      if (a >= 0.5) (a = t(a)), (g = this.getLinearTickPositions(a, b, c));
        ...
        (g = Ka(this.getLinearTickPositions(a, b, c), ka)),
        !d)
      )
    ...
    getMinorTickPositions: function () {
      ...
      if (this.isLog) {
        ...
        (d = d.concat(Ab(yb(c), this.min, this.max, a.startOfWeek))),
    ...
    setAxisTranslation: function (a) {
      ...
      if (this.isXAxis)
        g
          ...
          (g = this.ordinalSlope ? this.ordinalSlope / d : 1),
    ...
    setTickPositions: function (a) {
      ...
      if (!i)
        (i = f
          ? (b.getNonLinearTimeTicks || Ab)(
              yb(b.tickInterval, d.units),
              b.min,
              b.max,
              d.startOfWeek,
              b.ordinalPositions,
    ...
    zoom: function (a, b) {
      this.allowZoomOutside ||
        (a <= this.dataMin && (a = x), b >= this.dataMax && (b = x));
      ...
      if (B || f)
        if (
          ...
          g.length &&
            ...
            s &&
              a.min === 0 &&
              (j[-1] || (j[-1] = new Ia(a, -1, null, !0)), j[-1].render(-1))),
          p &&
            n(g, function (b, c) {
              if (c % 2 === 0 && b < a.max)
                m[b] || (m[b] = new ob(a)),
                  (t = b + s),
                  (v = g[c + 1] !== x ? g[c + 1] + s : a.max),
                  (m[b].options = {
                    from: e ? da(t) : t,
                    to: e ? da(v) : v,
                    color: p,
  ...
  pb.prototype = {
    ...
    getAnchor: function (a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === x && (b = d.pointer.normalize(b)),
  ...
  qb.prototype = {
    ...
    scaleGroups: function (a, b) {
      ...
      n(c.series, function (d) {
        d.xAxis.zoomEnabled &&
          (d.group.attr(a),
          d.markerGroup &&
            (d.markerGroup.attr(a), d.markerGroup.clip(b ? c.clipRect : null)),
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g) {
      ...
      x
        ? ((r -= 0.8 * (r - g[i][0])), q || (u -= 0.8 * (u - g[i][1])), c())
        : (g[i] = [r, u]);
      n || ((f[i] = s - l), (f[m] = p));
      f = n ? 1 / o : o;
      e[m] = p;
    ...
    pinch: function (a) {
      ...
      a.type === "touchstart" &&
        ...
        (b.inClass(a.target, "highcharts-tracker")
          ? (!c.runTrackerClick || g > 1) && a.preventDefault()
          : (!c.runChartClick || g > 1) && a.preventDefault());
      Ka(f, function (a) {
    ...
    drag: function (a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          e &&
          ((e = d - m),
          this.selectionMarker.attr({ width: Q(e), x: (e > 0 ? 0 : e) + m }));
        this.selectionMarker &&
          f &&
          ((e = a - l),
          this.selectionMarker.attr({ height: Q(e), y: (e > 0 ? 0 : e) + l }));
    ...
    renderItem: function (a) {
      ...
      if (
        ...
        (a.legendItem = n =
          d
            .text(
              e.labelFormat ? Ea(e.labelFormat, a) : e.labelFormatter.call(a),
              m ? g + h : -h,
              b.baseline,
              u
            )
        ...
        if (!m)
          (this.nav = m = d.g().attr({ zIndex: 1 }).add(this.group)),
            (this.up = d
              ...
              .add(m)),
            (this.pager = d.text("", 15, 10).css(i.style).add(m)),
            (this.down = d
      ...
      if ((this.title || this.subtitle) && !r(this.optionsMarginTop))
        if (
          (m = q(
            ...
            (this.subtitle && !m.floating && !m.verticalAlign && m.y) || 0
          ))
        )
    ...
    drawChartBox: function () {
      ...
      if (l)
        g
          ...
          : (this.plotBorder = b
              .rect(o, n, t, q, 0, l)
              .attr({ stroke: a.plotBorderColor, "stroke-width": l, zIndex: 1 })
              .add());
      this.isDirtyBox = !1;
    },
  ...
  R.prototype = {
      ...
      for (l = 0; l < g; l++)
        (i = h + l),
          j
            ...
            : (b[i]
                ? (k = b[i])
                : a[i] !== x && (b[i] = k = new f().init(this, a[i], d[l])),
              (m[l] = k));
      if (b && (g !== (c = b.length) || j))
        for (l = 0; l < c; l++)
          if ((l === h && !j && (l += g), b[l]))
    ...
    setTooltipPoints: function (a) {
      ...
      if (this.options.enableMouseTracking !== !1) {
        ...
        for (g = 0; g < a; g++) {
          ...
          for (
            d = b[g + 1]
              ? q(0, T((f.clientX + (b[g + 1] ? b[g + 1].clientX : e)) / 2))
              : e;
            c >= 0 && c <= d;
    ...
    tooltipHeaderFormatter: function (a) {
      ...
      e &&
        c &&
        Ca(a.key) &&
        (f = f.replace("{point.key}", "{point.key:" + c + "}"));
      ...
      if (m.enabled || this._hasPointMarkers)
        for (f = b.length; f--; )
          if (
            ...
            (k = g.graphic),
            (i = g.marker || {}),
            (a = (m.enabled && i.enabled === x) || i.enabled),
            (l = c.isInsidePlot(d, e, c.inverted)),
        ...
        if (f) {
          ...
          if (h.negative && b.marker)
            k[""].fill =
              k.hover.fill =
              k.select.fill =
                a.convertAttribs({ fillColor: l }).fill;
        } else k = j;
        h.pointAttr = k;
      }
    },
    ...
    clipNeg: function () {
      ...
      var h = b.chartHeight,
        i = q(e, h);
      if (d && this.graph)
        (d = ja(this.yAxis.len - this.yAxis.translate(a.threshold || 0))),
          (a = { x: 0, y: 0, width: i, height: d }),
          (i = { x: 0, y: d, width: i, height: i - d }),
          b.inverted &&
            c.isVML &&
            ((a = {
          ...
          this.yAxis.reversed ? ((b = i), (e = a)) : ((b = a), (e = i)),
          f
            ? (f.animate(b), g.animate(e))
            : ((this.posClip = f = c.clipRect(b)),
              this.graph.clip(f),
              (this.negClip = g = c.clipRect(e)),
              this.graphNeg.clip(g),
              this.area && (this.area.clip(f), this.areaNeg.clip(g)));
    },
    ...
    setVisible: function (a, b) {
      var c = this,
        ...
        h = c.visible;
      f = (c.visible = a = c.userOptions.visible = a === x ? !h : a)
        ? "show"
        : "hide";
    ...
    drawTracker: function () {
      ...
      if (e && !c)
        for (l = e + 1; l--; )
          d[l] === "M" && d.splice(l + 1, 0, d[l + 1] - i, d[l + 2], "L"),
            ((l && d[l] === "M") || l === e) &&
    ...
    getColumnMetrics: function () {
      ...
      c.grouping === !1
        ...
        : n(b.series, function (b) {
            ...
            if (b.type === a.type && b.visible && a.options.group === c.group)
              c.stacking
                ? ((f = b.stackKey), g[f] === x && (g[f] = i++), (h = g[f]))
                : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h);
          });
      var b = K(
          Q(d.transA) *
            (d.ordinalSlope || c.pointRange || d.closestPointRange || 1),
          d.len
        ),
        d = b * c.groupPadding,
        j = (b - 2 * d) / i,
      ...
      return (a.columnMetrics = {
        ...
        offset:
          c +
          (d +
            ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * j -
            b / 2) *
            (e ? -1 : 1),
      });
    },
  ...
  W = {
          ...
          for (C = 0; C < J; C++) {
            ...
            if (this.options.size === null)
              (w = v.width),
                A - w < f
                  ? (D[3] = q(t(w - A + f), D[3]))
                  : A + w > h - f && (D[1] = q(t(A + w - h + f), D[1])),
                z - x / 2 < 0
                  ? (D[0] = q(t(-z + x / 2), D[0]))
                  : z + x / 2 > d && (D[2] = q(t(z + x / 2 - d), D[2]));
          }
        }
    ...
    verifyDataLabelOverflow: function (a) {
      ...
      d[1] !== null
        ...
        : ((e = q(K(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
      e < b[2]
        ? ((b[2] = e),
          this.translate(b),
