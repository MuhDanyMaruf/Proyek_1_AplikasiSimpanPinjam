          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              ...
              <div class="panel-body">
                <span style="font-size:20px;"><?php echo 'Rp. ' . number_format($pendapatan); //.' '.$tabung['tabung'].' '.$angsur['angsuran'].' '.$denda['denda']; 
                                              ?></span>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-xs-10">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              ...
              <div class="panel-body">
                <span style="font-size:20px;"><?php echo 'Rp. ' . number_format($pengambilan); //.' '.$tabung['tabung'].' '.$angsur['angsuran'].' '.$denda['denda']; 
                                              ?></span>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-xs-10">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              ...
              <div class="panel-body">
                <span style="font-size:20px;"><?php echo 'Rp. ' . number_format($sisapen); //.' '.$tabung['tabung'].' '.$angsur['angsuran'].' '.$denda['denda']; 
                                              ?></span>
              </div>
            </div>
          </div>
